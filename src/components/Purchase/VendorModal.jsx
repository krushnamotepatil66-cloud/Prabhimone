...
function VendorModal({ isOpen, onClose, onSave, editingVendor, initialName = "" }) {
  ...
  }, [editingVendor, initialName, isOpen]);
  ...
  const handleSubmit = (e) => {
    ...
    if (form.email && !isValidEmail(form.email)) {
      alert("Please enter a valid email address (e.g. vendor@gmail.com).");
      return;
    }
            ...
            <div className="form-row-custom">
              <div className="form-group-custom half-width">
                ...
                <input
                  ...
                  placeholder="ex. vendor@gmail.com"
                />
              </div>
              <div className="form-group-custom half-width">
