...
function CreateEstimateForm({ editingEstimate, onSave, onCancel }) {
  const { customers, estimates, addCustomer, settings } = useApp();
    ...
    if (editingEstimate) {
      ...
      setForm({
        ...
        items: editingEstimate.items && editingEstimate.items.length > 0
          ...
          : [{ product: "Service Consultation", description: "", hsn: "", qty: "1", unit: "Nos", price: String(parseAmount(editingEstimate.amount)), discount: "", discountType: "Flat", tax: "18" }],
